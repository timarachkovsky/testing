classdef spectrogramLog < spectrogram1
    ...
    methods
        ...
        function [mySpectrogram] = spectrogramLog( config )
        ...
        function [mySpectrogram] = create(mySpectrogram, file)
            ...
            [mySpectrogram] = create@spectrogram1(mySpectrogram, file);
