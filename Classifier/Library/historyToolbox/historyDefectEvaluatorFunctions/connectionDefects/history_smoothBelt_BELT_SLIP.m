% HISTORY_SMOOTHBELT_BELT_SLIP function returns status of smooth belt defect of
% history
% 
% Defect requirements:
%     main:
...
function [similarityHistory, historyDangerous] = history_smoothBelt_BELT_SLIP(defectStruct, myFiles)
