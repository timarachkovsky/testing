% HISTORY_INDUCTIONMOTOR_NON_LINEAR_DISTORTION_SUPPLY_VOLTAGE function returns
...
function [similarityHistory, historyDangerous] = history_inductionMotor_NON_LINEAR_DISTORTION_SUPPLY_VOLTAGE(defectStruct,~)
