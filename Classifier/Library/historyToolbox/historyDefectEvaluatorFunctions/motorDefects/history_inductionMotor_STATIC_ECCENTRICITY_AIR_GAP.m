% history_INDUCTIONMOTOR_ECCENTRICITY_AIR_GAP function returns status of
...
function [similarityHistory, historyDangerous] = history_inductionMotor_STATIC_ECCENTRICITY_AIR_GAP(defectStruct,~)
