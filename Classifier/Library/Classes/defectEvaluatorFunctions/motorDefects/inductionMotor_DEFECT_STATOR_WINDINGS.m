% INDUCTIONMOTOR_DEFECT_STATOR_WINDINGS function returns status of
% induction motor defect "Defect of Stator Windings" (defectID = 5)
% 
% Defect requirements:
%     main:
%         1) k1 * barFreq +(-) k2 * twiceLineFreq, k1 < 4;
%     additional:
%         1) 1 * twiceLineFreq;
% 
...
function [similarity, level, defectStruct] = inductionMotor_DEFECT_STATOR_WINDINGS(defectStruct, ~, initialPeakTable)
