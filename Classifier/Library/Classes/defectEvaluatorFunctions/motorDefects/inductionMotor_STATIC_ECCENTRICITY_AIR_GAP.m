% INDUCTIONMOTOR_STATIC_ECCENTRICITY_AIR_GAP function returns status of
% induction motor defect "Static Eccentricity of the Air Gap" (defectID =
% 1)
% 
% Defect requirements:
%     main:
...
function [similarity, level, defectStruct] = inductionMotor_STATIC_ECCENTRICITY_AIR_GAP(defectStruct, ~, ~)
