% INDUCTIONMOTOR_NON_LINEAR_DISTORTION_SUPPLY_VOLTAGE function returns
% status of induction motor defect "Non-linear Distortion of Supply
% Voltage" (defectID = 6)
% 
% Defect requirements:
%     main:
...
function [similarity, level, defectStruct] = inductionMotor_NON_LINEAR_DISTORTION_SUPPLY_VOLTAGE(defectStruct, ~, ~)
